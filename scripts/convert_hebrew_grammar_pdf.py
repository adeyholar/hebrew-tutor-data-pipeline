...
# Enhanced pipeline using Azure Document Intelligence for OCR, PyMuPDF for PDF rendering.
...
def ocr_hebrew_page(image_path):
    ...
    with open(image_path, "rb") as img:
        poller = client.begin_analyze_document("prebuilt-read", analyze_request=img, content_type="image/png")
        result = poller.result()
    text = ' '.join([span.content for page in result.pages for line in page.lines for span in line.spans])
    # Placeholder for D-Nikud (integrate actual model from Dicta-IL)
