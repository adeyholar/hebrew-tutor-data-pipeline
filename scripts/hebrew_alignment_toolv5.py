...
# Book to folder and abbreviation mapping (excluding Aramaic)
BOOK_MAPPING = {
...
class HebrewBibleAligner:
    ...
    def __init__(self):
        ...
        if self.storage_connection_string:
            ...
            try:
                ...
                logger.info(f"Container 'hebrew-audio' already exists or error: {e}")
    ...
    def _get_audio_filename(self, book_code: str, chapter: int) -> Path:
        ...
        mapping = BOOK_MAPPING[book_code]
...
async def main():
    ...
    try:
        ...
        # Test single chapter (uncomment for debugging)
        # success = await aligner.process_chapter('1Chr', 1)
        # print(f"Single chapter processing: {'Success' if success else 'Failed'}")
